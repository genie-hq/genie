  ...
  try {
    ...
    if (error.status === 404) {
      await checkAndCreateDummyDirectory({
        ...
        dummyMessage: 'chore: create dummy file in .github directory',
      });
      ...
      await checkAndCreateDummyDirectory({
        ...
        dummyMessage: 'chore: create dummy file in .github/workflows directory',
      });
...
export async function createGenieYaml({
  ...
  const genieYamlCommitMsg = 'chore: create a genie.yaml file';
