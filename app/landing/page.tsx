      ...
      <div className="flex w-full items-center justify-center gap-2">
        <div className="flex flex-col w-full md:w-1/2 md:pl-16 gap-4 md:gap-8">
          <h1 className='text-lg md:text-2xl font-semibold'>
            <span
              className='overflow-hidden bg-gradient-to-r bg-clip-text font-bold text-transparent dark:from-pink-300 dark:via-amber-200 dark:to-blue-300 from-pink-600 via-purple-500 to-sky-500'>
              Intelligenie.ai
            </span>
          </h1>
