...
alter table "public"."test_files" drop column "branch";

alter table "public"."test_files" drop column "file_path";

alter table "public"."test_files" drop column "github_username";

alter table "public"."test_files" drop column "repository";

alter table "public"."test_files" drop column "target_branch";

alter table "public"."test_files" drop column "test_framework";

alter table "public"."test_files" drop column "test_library";

alter table "public"."test_files" add column "branch_id" uuid not null default gen_random_uuid();

alter table "public"."test_files" add column "language" text not null default 'typescript'::text;

alter table "public"."test_files" add column "path" text not null;

alter table "public"."test_files" add column "test_library_id" uuid not null default gen_random_uuid();

alter table "public"."test_files" add column "updated_at" timestamp without time zone not null default now();

alter table "public"."test_files" alter column "created_at" set not null;

alter table "public"."test_files" alter column "created_at" set data type timestamp without time zone using "created_at"::timestamp without time zone;

alter table "public"."test_files" alter column "name" set not null;
